...
def generate_password(is_lower: bool, is_upper: bool, is_spec: bool, is_digit: bool, length: int):
    '''
    ...
    chars_for_password += string.ascii_lowercase*is_lower + string.ascii_uppercase*is_upper
